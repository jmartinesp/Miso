...
public class Document: Element {
    ...
    public override var outputSettings: OutputSettings {
        get {
    ...
    public func create(element tagName: String) -> Element {
     ...
     */
    @discardableResult
    public func normalize() -> Document {
    ...
    public override var outerHTML: String {
        return super.html
    }
