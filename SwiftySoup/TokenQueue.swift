...
public class TokenQueue {
    ...
    public func add(first char: UnicodeScalar) {
     ...
     */
    public func matches(any texts: [String]) -> Bool {
        for text in texts {
    ...
    public func matches(any chars: [UnicodeScalar]) -> Bool {
        for char in chars {
            if queue[pos] == char {
                return true
            }
    ...
    public func matchesStartTag() -> Bool {
     ...
     */
    public func matchAndChomp(text: String) -> Bool {
    ...
    public func matchesWhitespace() -> Bool {
        return !isEmpty && queue[pos].isWhitespace
    }
    
    public func matchesWord() -> Bool {
     ...
     */
    public func consume(text: String) {
        if !matches(text: text) {
            // TODO maybe throw?
    ...
    public func consume(to text: String, ignoreCase: Bool = false) -> String {
    ...
    public func consume(toAny strings: [String]) -> String {
        let start = pos
     ...
     */
    public func chomp(to text: String, ignoreCase: Bool = false) -> String {
    ...
    public func consumeAttributeKey() -> String {
        let start = pos
