...
class SelectorTest: XCTestCase {
    ...
    func testByTag() {
        ...
        let els = SwiftySoup.parse(html: "<div id=1><div id=2><p>Hello</p></div></div><DIV id=3>").select("DIV")
        XCTAssertEqual(3, els.count)
        XCTAssertEqual("1", els[0].id)
        XCTAssertEqual("2", els[1].id)
        XCTAssertEqual("3", els[2].id)
        
        let none = SwiftySoup.parse(html: "<div id=1><div id=2><p>Hello</p></div></div><div id=3>").select("span")
        XCTAssertEqual(0, none.count)
    }
    
    func testById() {
        let els = SwiftySoup.parse(html: "<div><p id=foo>Hello</p><p id=foo>Foo two!</p></div>").select("#foo")
        XCTAssertEqual(2, els.count)
        XCTAssertEqual("Hello", els[0].text)
        XCTAssertEqual("Foo two!", els[1].text)
        
        let none = SwiftySoup.parse(html: "<div id=1></div>").select("#foo")
        XCTAssertEqual(0, none.count)
    }
    
    func testByClass() {
        let els = SwiftySoup.parse(html: "<p id=0 class='ONE two'><p id=1 class='one'><p id=2 class='two'>").select("P.One")
        XCTAssertEqual(2, els.count)
        XCTAssertEqual("0", els[0].id)
        XCTAssertEqual("1", els[1].id)
        
        let none = SwiftySoup.parse(html: "<div class='one'></div>").select(".foo")
        XCTAssertEqual(0, none.count)
        
        let els2 = SwiftySoup.parse(html: "<div class='One-Two'></div>").select(".one-two")
    ...
    func testByClassCaseInsensitive() {
        ...
        let elsFromClass = SwiftySoup.parse(html: html).select("P.Foo")
        let elsFromAttr = SwiftySoup.parse(html: html).select("p[class=foo]")
    ...
    func testNamespacedTag() {
        let doc = SwiftySoup.parse(html: "<div><abc:def id=1>Hello</abc:def></div> <abc:def class=bold id=2>There</abc:def>")
    ...
    func testByAttributeStarting() {
        let doc = SwiftySoup.parse(html: "<div id=1 data-name=jsoup>Hello</div><p data-val=5 id=2>There</p><p id=3>No</p>")
    ...
    func testByAttributeRegex() {
        let doc = SwiftySoup.parse(html: "<p><img src=foo.png id=1><img src=bar.jpg id=2><img src=qux.JPEG id=3><img src=old.gif><img></p>")
    ...
    func testByAttributeRegexCharacterClass() {
        let doc = SwiftySoup.parse(html: "<p><img src=foo.png id=1><img src=bar.jpg id=2><img src=qux.JPEG id=3><img src=old.gif id=4></p>")
    ...
    func testByAttributeRegexCombined() {
        let doc = SwiftySoup.parse(html: "<div><table class=x><td>Hello</td></table></div>")
    ...
    func testCombinedWithContains() {
        let doc = SwiftySoup.parse(html: "<p id=1>One</p><p>Two +</p><p>Three +</p>")
    ...
    func testGroupOrAttribute() {
        ...
        let els = SwiftySoup.parse(html: h).select("[id],[title=foo]")
    ...
    func testSupportsLeadingCombinator() {
        ...
        var doc = SwiftySoup.parse(html: h)
        ...
        doc = SwiftySoup.parse(html: h)
        let div = doc.select("div").select(" > div").first!
        XCTAssertEqual("2", div.id)
    }
    
    func testPseudoLessThan() {
        let doc = SwiftySoup.parse(html: "<div><p>One</p><p>Two</p><p>Three</>p></div><div><p>Four</p>")
    ...
    func testPseudoCombined() {
        let doc = SwiftySoup.parse(html: "<div class='foo'><p>One</p><p>Two</p></div><div><p>Three</p><p>Four</p></div>")
    ...
    func testPseudoHas() {
        let doc = SwiftySoup.parse(html: "<div id=0><p><span>Hello</span></p></div> <div id=1><span class=foo>There</span></div> <div id=2><p>Not</p></div>")
    ...
    func testNestedHas() {
        let doc = SwiftySoup.parse(html: "<div><p><span>One</span></p></div> <div><p>Two</p></div>")
    ...
    func testPseudoContains() {
        let doc = SwiftySoup.parse(html: "<div><p>The Rain.</p> <p class=light>The <i>rain</i>.</p> <p>Rain, the.</p></div>")
    ...
    func testPsuedoContainsWithParentheses() {
        let doc = SwiftySoup.parse(html: "<div><p id=1>This (is good)</p><p id=2>This is bad)</p>")
    ...
    func testContainsOwn() {
        let doc = SwiftySoup.parse(html: "<p id=1>Hello <b>there</b> now</p>")
    ...
    func testMatches() {
        let doc = SwiftySoup.parse(html: "<p id=1>The <i>Rain</i></p> <p id=2>There are 99 bottles.</p> <p id=3>Harder (this)</p> <p id=4>Rain</p>")
    ...
    func testRelaxedTags() {
        let doc = SwiftySoup.parse(html: "<abc_def id=1>Hello</abc_def> <abc-def id=2>There</abc-def>")
    ...
    func testNotParas() {
        let doc = SwiftySoup.parse(html: "<p id=1>One</p> <p>Two</p> <p><span>Three</span></p>")
    ...
    func testNotAll() {
        let doc = SwiftySoup.parse(html: "<p>Two</p> <p><span>Three</span></p>")
    ...
    func testNotClass() {
        let doc = SwiftySoup.parse(html: "<div class=left>One</div><div class=right id=1><p>Two</p></div>")
    ...
    func testHandlesCommasInSelector() {
        let doc = SwiftySoup.parse(html: "<p name='1,2'>One</p><div>Two</div><ol><li>123</li><li>Text</li></ol>")
    ...
    func testSelectSupplementaryCharacter() {
        ...
        let doc = SwiftySoup.parse(html: "<div k" + s + "='" + s + "'>^" + s + "$/div>")
